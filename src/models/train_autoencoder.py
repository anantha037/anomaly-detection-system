...
def train():
    ...
    with mlflow.start_run(run_name="lstm_autoencoder"):
        ...
        mlflow.log_metrics(
            {"threshold": float(best_threshold), "precision": precision, "recall": recall, "f1_score": f1}
        )
        ...
        mlflow.pytorch.log_model(pytorch_model=model, artifact_path="model", registered_model_name="LSTM_Autoencoder")
